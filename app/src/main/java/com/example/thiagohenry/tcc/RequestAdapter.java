...
public class RequestAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Customer customer_find = realm.where(Customer.class).equalTo("id", result_customer.get(position).getId()).findFirst();
        Status   status_find   = realm.where(Status.class).equalTo("id", result_status.get(position).getId()).findFirst();
